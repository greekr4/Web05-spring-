                        ...
                        <div class="page_content">
                            ...
                            <div class="search_box">
                                <form action="/myapp/board/news_search" method="POST">
                                    ...
                                    <button type="button" class="btn_clear" style="float: right; width: 100px; margin-right: 1%;" onclick="location.href='${path}/Admin/OrderList?type=1';">전체보기 (${OrderCnt })</button>
                                </form>
                            </div>
                            <!-- /검색 -->
                            <!-- 주문서 테이블 -->
