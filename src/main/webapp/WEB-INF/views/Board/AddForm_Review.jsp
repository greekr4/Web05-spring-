                    ...
                    <div class="table_form_wrap">
                        <table class="table_form">
                            <tbody>
                                ...
                                -->
                                <tr>
                                    <th><label for="dtitle">별점</label></th>
                                    <td>
                                    <button class="btn_black" type="button" onclick="$('#star').val('5'); $('.btn_black').attr('class','btn_clear'); $(this).attr('class','btn_black');">★★★★★★</button>  
                                    <button class="btn_clear" type="button" onclick="$('#star').val('4'); $('.btn_black').attr('class','btn_clear'); $(this).attr('class','btn_black');">★★★★☆</button>   
                                    <button class="btn_clear" type="button" onclick="$('#star').val('3'); $('.btn_black').attr('class','btn_clear'); $(this).attr('class','btn_black');">★★★☆☆</button>      
                                    <button class="btn_clear" type="button" onclick="$('#star').val('2'); $('.btn_black').attr('class','btn_clear'); $(this).attr('class','btn_black');">★★☆☆☆</button>                         
                                    <button class="btn_clear" type="button" onclick="$('#star').val('1'); $('.btn_black').attr('class','btn_clear'); $(this).attr('class','btn_black');">★☆☆☆☆</button>
                                    <input type="hidden" value="5" id="star" name="star">
