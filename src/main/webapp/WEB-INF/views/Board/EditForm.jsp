                            ...
                            <tbody>
                            	<tr>
                                 ...
                                 <tr>
                                    ...
                                    <td><input type="text" name="" id="writer" size="100" class="single100"
                                            placeholder="작성자 입력" value="${DTO.name }" readonly> </td>
                                </tr> 
                                <tr>
                                    <th><label for="dtitle">제목</label></th>
                                    <td><input type="text" name="title" id="title" size="100" class="single100"
                                            placeholder="글제목 입력" value="${DTO.title }" required ></td>
                                </tr>
                                <tr>
                                    <th><label for="editor">내용</label></th>
                                    <td><textarea name="content" id="editor" cols="100" rows="8"
                                            class="multi100" placeholder="글 내용 입력" required>${DTO.content }</textarea></td>
                                </tr>                                
                                <tr>
                                    <th></th>
                                    <td>
