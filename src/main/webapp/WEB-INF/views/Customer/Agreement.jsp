...
<title>Insert title here</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0;}
        ...
        .agree_content_wrap ul > li:nth-child(n){
            margin-bottom: 2%;
        }
        .agree_content_wrap ul > li:nth-child(3n){
            margin-bottom: 10%;
        }
        .agree_content {
            display: block;
        ...
        .agree_content_wrap ul > li:last-child{
            text-align: center;
            margin-right: 5%;
        }
        .agree_content_wrap ul > li > button{
            height: 4.5vh;
            width: 30%;
            margin-top: 2%;
        }
        .agree_content_wrap ul > li > strong {
            font-size: 18px;
        }
        /* /약관 동의 */
    </style>
            ...
            <div id="container_wrap">
             <section class="main_wrap">
                    <div class="main_title">
                        <h2>회원가입</h2>
                        <p><strong>01 약관동의</strong> > 02 정보입력 > 03 가입완료</p>
                    </div>
                    <!-- 약관동의 -->
                    <div class="agree_wrap">
                        <div class="agree_content_wrap">
                            <div role="form">
                                <ul>
                                    <li>
                                        <input type="checkbox" name="ck3" id="ck3" value="allck" onclick="fnc2(this)">
                                        <label for="ck3"><strong> 비앤투유의 모든 약관을 확인하고 전체 동의합니다.</strong></label>
                                    </li>
                                    <li>
                                        <input type="checkbox" name="ck1" id="ck1">
                                        <label for="ck1"><b> 회원약관에 동의합니다.</b></label>
                                    </li>
                                    <li>
                                        <div class="agree_content">
                                            ...
                                            표준약관 제10023호<br />
                                            <br />
                                            이 약관은 (주)비앤투유 회사(전자거래 사업자)가 운영하는 포터리하우스 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br />
                                            ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」<br />
                                            <br />
                                            <br />
                                            제2조(정의)<br />
                                            <br />
                                            ① "몰"이란 (주)비앤투유 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br />
                                            ...
                                            부칙<br />
                                            <br />
                                            1. 이 약관은 2021년 08월 01일부터 적용됩니다.<br />
                                        </div>
                                    </li>
                                    <li>
                                        <input type="checkbox" name="ck2" id="ck2">
                                        <label for="ck2"><b> 개인정보처리방침에 동의합니다.</b></label>
                                    </li>
                                    <li>
                                        <div class="agree_content">
                                            회사는 회원가입, 민원 등 고객상담 처리, 본인확인(14세 미만 아동 확인) 등 의사소통을 위한 정보 활용 및 이벤트 등과 같은 마케팅용도 활용, 회원의 서비스 이용에 대한 통계, 이용자들의 개인정보를 통한 서비스 개발을 위해 아래와 같은 개인정보를 수집하고 있습니다.<br />
                                            <br />
                                    ...
                                    <li>
                                        <button id="btn1" onclick="fnc1()" class="btn_clear">회원가입</button>
                                        ...
                                        <script>
                                            function fnc2(allck)  {
                                                const ck1 = document.getElementsByName('ck1');
                                                ck1.forEach((checkbox) => {checkbox.checked = ck3.checked;})
                                                const ck2 = document.getElementsByName('ck2');
                                                ck2.forEach((checkbox) => {checkbox.checked = ck3.checked;})
                                            }
                                        </script>
                                    </li>
                                </ul>
